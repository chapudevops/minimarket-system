    ...
    <div class="page-content">
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <p class="mb-0 text-muted small">Crea un nuevo combo de productos con precio especial</p>
                    </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('combos.store') }}" method="POST" id="formCombo" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3 text-center">
                            ...
                            <div class="foto-preview-container mx-auto mb-2" id="fotoPreviewContainer">
                                <img id="fotoPreviewImg" src="{{ URL::asset('build/images/default-product.png') }}" alt="Preview">
                            </div>
                        ...
                        <div class="col-md-9">
                            <div class="row g-3">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ej: Combo Desayuno" value="{{ old('nombre') }}" required>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="descripcion" name="descripcion" rows="2" placeholder="Descripción del combo (opcional)">{{ old('descripcion') }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    <label for="precio_combo" class="form-label fw-bold">Precio del Combo <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text">S/</span>
                                        <input type="number" class="form-control" id="precio_combo" name="precio_combo" step="0.01" min="0" placeholder="0.00" value="{{ old('precio_combo') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
