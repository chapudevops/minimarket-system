        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h4 class="mb-0">
                            <i class="bi bi-file-text"></i> Gestión de Cotizaciones
                        </h4>
                        <p class="mb-0 text-muted small">Administra las cotizaciones del sistema</p>
                    </div>
        ...
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title text-white">
                    <i class="bi bi-info-circle"></i> Detalle de Cotización
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body" id="cotizacionDetails">
...
<script src="{{ URL::asset('build/js/cotizacion/config.js')}}"></script>
@endsection