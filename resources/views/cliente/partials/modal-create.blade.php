                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="numero_documento" id="numero_documento_create" class="form-control" placeholder="12345678">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="nombre_razon_social" id="nombre_razon_social_create" class="form-control" placeholder="Juan Pérez">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="distrito" id="distrito_create" class="form-control" placeholder="Miraflores">
